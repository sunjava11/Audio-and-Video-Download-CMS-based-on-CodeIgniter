            ...
            <aside class="main-sidebar hidden-print">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
						...
						<li>
                            <a href="#">
                                <i class="fa fa-desktop"></i> <span>Index Songs</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('admin/uploadedfile/mp3');?>"><i class="fa fa-plus"></i> Index MP3</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('admin/uploadedfile/mp4');?>"><i class="fa fa-list-ul"></i> Index Videos</a>
                                </li>
							</ul>
                        </li>
						<li>
                            <a href="#">
                                <i class="fa fa-desktop"></i> <span>Albums</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
